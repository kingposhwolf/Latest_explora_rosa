...
public class SpotifyController {
    ...
    @PostMapping("/songId")
    public ResponseEntity<SpotifySong> getSongById(@RequestParam String songId) {
        return spotifyService.getSongById(songId);
    }

    @GetMapping("/searchTrack")
    public ResponseEntity<SpotifySong> searchSong(@RequestParam String query) {
        return spotifyService.searchSong(query);
    }
}
//
