...
public interface CommentRepository extends CrudRepository<Comment, Long> {
    ...
    @Query("SELECT DISTINCT l.commenter.id as profileId, l.likes as likes, l.commenter.verificationStatus as verificationStatus, l.commenter.user.username as username, l.commenter.user.name as name, l.message as message, l.id as id, l.timestamp as timestamp  FROM Comment l WHERE l.userPost.id = :postId AND l.parentComment IS NULL")
