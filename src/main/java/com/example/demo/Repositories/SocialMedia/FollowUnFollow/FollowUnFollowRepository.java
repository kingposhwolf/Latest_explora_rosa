package com.example.demo.Repositories.SocialMedia.FollowUnFollow;
...
List<Map<String, Object>> searchOnFollowing(@Param("targetId") Long targetId, @Param("searchText") String searchText);
